...
<body>
    <div class="container">
        ...
        <div class="sidebar" id="sidebar">
            <ul>
                <li><a href="review.php">審核賣家</a></li>
        ...
        <div class="content1">
            <div style="width: 1360px; height: 1588px; position: relative; background: white">
                ...
                <div><img style="width: 358px; height: 67px; left: 110px; top: 1302px; position: absolute" src='images/connect.png' />
                    ...
                    if ($dbcon1) {
                        $sql = "SELECT * FROM user where type=1||type=2";
                        ...
                        if (mysqli_num_rows($result) > 0) {  // 查詢結果有資料
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<td style='text-align:center;'><a class='btn btn-danger' onclick=\"return delConfirm('" . $row["username"] . "')\" " . "href='deleteuser.php?id=" . $row["id"] . "'>刪除</a></td>\n";
                                echo "</tr>";
                            }
