...
<body>
    <div class="container">
        ...
        <div class="sidebar" id="sidebar">
            <ul>
                <li><a href="admin.php">回管理者首頁</a></li>
                ...
                <div><img style="width: 358px; height: 67px; left: 110px; top: 1302px; position: absolute" src='images/connect.png' />
                    ...
                    if ($dbcon1) {
                        ...
                        if (mysqli_num_rows($result) > 0) {  // 查詢結果有資料
                            ...
                            echo "<tr>";
                            echo "<th style='text-align:center;width:10%'>使用者型態</th>";
                            echo "<th style='text-align:center;width:10%'>名稱</th>";
                            echo "<th style='text-align:center;width:10%'>電話</th>";
                            echo "<th style='text-align:center;width:10%'>信箱</th>";
                            echo "<th style='text-align:center;width:10%'>密碼</th>";
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<td style='text-align:center; width=10%'><a class=\"btn btn-primary\" href=\"adduserformreview.php?id=" . $row["id"] . "\">通過</a></td>\n";
                                echo "<td style='text-align:center;'><a class='btn btn-danger' onclick=\"return delConfirm('" . $row["username"] . "')\" " . "href='deleteuserformreview.php?id=" . $row["id"] . "'>刪除</a></td>\n";
                                echo "</tr>";
                            }
